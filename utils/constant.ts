...
export const productList = [
    {
      ...
      price: 4350,
      originalPrice: 6758,
      description: "Short dress with a square neckline. Short puff sleeves. In-seam side pockets. Featuring a pleated and lace detail in the same fabric. Matching lining. Concealed side zip fastening",
      images: [
    ...
    },
    {
      ...
      price: 3440,
      originalPrice: 3440,
      description: "V-neck, long sleeve dress. Featuring contrast embroidered flowers, a beaded cord belt with tassels and a lining. Front button fastening.",
      images: [
    ...
    },
    {
      ...
      price: 3550,
      originalPrice: 3550,
      description: "V-neck dress with elbow-length sleeves and elasticated cuffs. Featuring a matching fabric belt with a contrasting buckle and perforated rubberised embroidery. Button fastening at the front.",
      images: [
    ...
    },
    {
      ...
      price: 4350,
      originalPrice: 4999,
      description: "Dress with a lapel collar, v-neck and long sleeves with elasticated cuffs. Gathered detail. Lining. Front button fastening.",
      images: [
    ...
    },
    {
      ...
      price: 4350,
      originalPrice: 5670,
      description: "V-neck long sleeve dress. Featuring front pintucks and lace inserts, an elasticated waist with a matching belt, metallic thread print, lined skirt and tonal covered button front fastening.",
      images: [
    ...
    },
    {
      ...
      price: 3550,
      originalPrice: 3550,
      description: "Short dress with a straight neckline. Straps with bow detail. Matching lining. Concealed zip fastening at the back.",
      images: [
    ...
    },
    {
      ...
      price: 3550,
      originalPrice: 4550,
      description: "Long v-neck dress with straps. Matching inner lining. Godet hem.",
      images: [
    ...
    },
    {
      ...
      price: 2950,
      originalPrice: 3450,
      description: "Short dress with a cowl neck and adjustable halter straps. Lining. Asymmetric ruffled hem.",
      images: [
    ...
    },
    {
      ...
      price: 4950,
      originalPrice: 4950,
      description: "Midi dress with a lapel collar and sleeves falling below the elbow. Self-tie belt in the same fabric. Front button fastening.",
      images: [
    ...
    },
    {
      ...
      price: 4350,
      originalPrice: 4350,
      description: "Round neck dress with wide straps. Featuring contrast topstitching and a flared hem. Concealed side zip fastening.",
      images: [
    ...
    },
    {
      ...
      price: 7500,
      originalPrice: 8900,
      description: "Midi dress made of viscose blend yarn. V-neck and sleeveless with shoulder pads. Featuring a draped front. Concealed zip fastening at the back.",
      images: [
    ...
    },
    {
      ...
      price: 4950,
      originalPrice: 5400,
      description: "Lapel collar, V-neck dress with a drawstring. Long sleeves, front flaps and patch pockets. Gathered waist. Concealed side zip fastening.",
      images: [
    ...
    },
    {
      ...
      price: 4950,
      originalPrice: 6700,
      description: "Sleeveless lapel neck dress with shoulder pads. Featuring a side opening at the waist with a metal buckle and an invisible side zip fastening.",
      images: [
    ...
    },
    {
      ...
      price: 10950,
      originalPrice: 12300,
      description: "Midi dress with a round neckline and thin straps. Floral patchwork detail. Lined.",
      images: [
