...
const _padding = 12;
const FavoriteFilterModal = forwardRef<Ref>((props, ref) => {
      ...
      <BottomSheetView>
        ...
        >
          ...
          <FilterListItem
            ...
            icon={<NoDiscountIcon tint={LuxuryColors.brandColor} size="50%" />}
            onPress={() => {}}
          />
        </View>
      </BottomSheetView>
...
const FilterListItem = ({ title, icon, onPress }: FilterListItemProps) => {
  return (
    <TouchableOpacity
      activeOpacity={0.6}
      onPress={onPress}
